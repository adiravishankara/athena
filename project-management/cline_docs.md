...
Maintain the 'project-management' folder in the root directory (create if it doesn't exist) with the following essential files:
...
5. tasklist.md
    - Purpose: Current, previous, and future objectives, this will help steer you in your development understanding what came before and what is coming after
    - Update: Prior to starting a new set of tasks, this will drive the actionplan
    - Format: Use headers (##) for main sections, subheaders (###) for components, bullet points for details
...
- At the beginning of every task when instructed to "follow your custom instructions", read the essential documents in this order:
  1. context.md (for high-level context and goals)
  2. actionplan.md (for specific current objectives)
  3. techStack.md
  4. codebaseSummary.md
  5. tasklist.md (for highlevel goal understanding)
